...
\begin{tabular}{l|c|c|c|c|}
                                                   & Alex       & Elie       & Yoann      & Brandon    \\
Réflexions sur les structures de données           & \checkmark & \checkmark & \checkmark & \checkmark \\
Préliminaires modèle du plateau de jeu             &            & \checkmark &            &            \\
Modèle de jeu avec données dans le plateau         & \checkmark & \checkmark & \checkmark &            \\
Premières méthodes utilitaires                     & \checkmark & \checkmark &            &            \\
Génération d'un plateau aléatoire                  & \checkmark &            & \checkmark &            \\
Seconde version du modèle, avec données séparées   & \checkmark & \checkmark & \checkmark &            \\
Premières réflexions sur A*                        &            & \checkmark & \checkmark & \checkmark \\
Interface graphique pour visualisation des données & \checkmark &            &            &            \\
Premiers essais sur A* et méthodes utilitaires     &            & \checkmark & \checkmark &            \\
Troisième version simplifiée du modèle de jeu      & \checkmark &            &            &            \\
Lecture et écriture des données du plateau         & \checkmark &            &            &            \\
Essais méthodes meilleurs noeuds et noeuds voisins &            & \checkmark & \checkmark &            \\
Clarification de A*, interface Comparable          & \checkmark &            &            &            \\
Ajout algorihme BFS                                & \checkmark &            &            &            \\
Corrections générales                              &            & \checkmark & \checkmark &            \\
Finalisation de l'interface graphique              & \checkmark & \checkmark & \checkmark &            \\
Rapport                                            & \checkmark & \checkmark & \checkmark &            \\
Présentation soutenance                            &            & \checkmark &            &           
\end{tabular}
\end{table}
